class Harnest < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "9716790e9525e881c0a3d29e99264ad62aae77ce32c738a4505bded62eaefa16"
    else
      url "https://github.com/AlexGladkov/harnest/releases/download/v0.3.0/harnest-v0.3.0-darwin-amd64.tar.gz"
      sha256 "50f6f51e1be8e63c721db4277ab5f267d41fc5dbe71c3614518cec2d996d41dc"
    end
  end

  on_linux do
    url "https://github.com/AlexGladkov/harnest/releases/download/v0.3.0/harnest-v0.3.0-linux-amd64.tar.gz"
    sha256 "f342df5de03da177a488213cf6e27adbb5ce18e29cc5861213a40fd063862713"
  end
