class Tokenplace < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/AlexGladkov/homebrew-tap/releases/download/tokenplace-v0.13.0/tokenplace-0.13.0-aarch64-apple-darwin.tar.gz"
      sha256 "b78c6c52ef2c3fe635c1dfbb9b56e937e161378c9fc80dd42b115e540a1658a0"
    else
      odie "tokenplace 0.13.0 ships only darwin-arm64 binaries via brew. Build from source: https://github.com/AlexGladkov/tokenplace"
    end
  end
